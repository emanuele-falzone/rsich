...
function ViewModel(params) {
    var self = this;
    self._repository = params.context.repositories['covers'];
...
ViewModel.prototype.id = 'details-playing';
...
ViewModel.prototype._propagate = function () {
    ...
    this._propagating = this._waitForDependencies().then(function () {
        self.filters['id'] = self.filters['id'] || (
            ...
            self.context.vms['details-question'].output['program']);
        self.status('ready');
...
exports.register = function () {
    ko.components.register('c-details-playing', {
        viewModel: {
