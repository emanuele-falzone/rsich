...
ViewModel.prototype.id = 'view-container-stagionale';
ViewModel.prototype.children = [
    'details-user-prizes-personal', // User Details
    'list-prizes-personal', // Prizes
];

exports.register = function () {
    ko.components.register('c-view-container-stagionale', {
        viewModel: {
